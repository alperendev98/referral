...
import referral_project.payment_method.fields
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.CharField(blank=True, max_length=30, null=True, verbose_name='Payment Email Address')),
            ],
            options={
                'verbose_name': 'PaymentInformation',
                'verbose_name_plural': 'PaymentInformation',
            },
        ),
        migrations.CreateModel(
            name='PaymentMethod',
        ...
        migrations.AddField(
            ...
            name='payment_method',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='payment_information', to='payment_method.PaymentMethod'),
        ),
    ]
