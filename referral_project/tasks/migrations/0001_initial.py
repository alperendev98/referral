# -*- coding: utf-8 -*-
# Generated by Django 1.11.8 on 2018-04-13 00:49
...
import referral_project.campaigns.fields
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('kind', models.IntegerField(choices=[(0, 'Video'), (1, 'Website'), (2, 'Survey')], default=referral_project.campaigns.fields.CampaignKind(0))),
                ...
                ('status', models.IntegerField(choices=[(0, 'Inactive'), (1, 'Active')], default=referral_project.utils.django.fields.ActiveInactiveStatus(0))),
                ('max_interactions', models.IntegerField(verbose_name='Maximum allowed interactions')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('task', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='task_status', to='tasks.Task')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='interacted_tasks', to=settings.AUTH_USER_MODEL)),
            ],
            options={
