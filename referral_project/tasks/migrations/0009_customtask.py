# -*- coding: utf-8 -*-
# Generated by Django 1.11.8 on 2018-09-17 17:52
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('tasks', '0008_taskstatus_parent_campaign'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reward', djmoney.models.fields.MoneyField(decimal_places=2, default=Decimal('0.0'), max_digits=10)),
                ('instruction', models.CharField(max_length=2000)),
                ('status', models.IntegerField(choices=[(0, 'Pending'), (1, 'Approved'), (2, 'Declined')], default=referral_project.utils.django.fields.ApproveStatus(0))),
                ('max_interactions', models.PositiveIntegerField(validators=[django.core.validators.MinValueValidator(1)], verbose_name='Maximum allowed interactions')),
                ('campaign', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='custom_tasks', to='campaigns.Campaign')),
            ],
            options={
                'verbose_name': 'CustomTask',
                'verbose_name_plural': 'CustomTasks',
            },
        ),
    ]
